...
├── 📂 reports/                  # Automated reports (generated by pipelines)
...
```yaml
# Automated daily reports are generated via Azure Pipeline
# See: pipelines/report-generation-pipeline.yml
# Setup guide: docs/report-generation-setup.md

# View latest reports
cat reports/sonarqube-projects-report.md
```
